...
d <- data.frame(gender =c(0,1,2,3,4,5,6,7,8),patient=1)

male <- data.frame(xmin=0.9, xmax=1.5, ymin=0, ymax=2)
female <- data.frame(xmin=4.5, xmax=7.0, ymin=0, ymax=2)


figure <- ggplot(d, aes(x=8, y=2))+
